...
/**
 * @swagger
 * /admin/dse/content/{id}/unpin:
 *   post:
 *     summary: Unpin DSE content
 *     description: Sets is_pinned false.
 *     tags: [Admin]
...
export const POST = withErrorHandler(async (req: NextRequest, props: IdParams) => {
  ...
  return ok(await setAdminDsePinned(id, adminId, false));
});
